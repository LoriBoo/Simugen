...
/**
 * Abstract implementation of {@link Source}.<br>
 * <br>
 * Implementation includes one {@link TransferOutputPipe} only.<br>
 * <br>
 * The {@link Source} generates {@link Element}s based on the passed
 * {@link DataGenerator}, generating up to the value of the passed integer,
 * {@link #arrivals}.<br>
 * <br>
 * <b>Eg;</b> if a {@link TriangularNumberGenerator} is passed for
 * {@link #elementGenerator} and {@link #arrivals} is set to 10; 10
 * {@link Element}s will be generated according to arrival times generated by
 * the {@link TriangularNumberGenerator}.
 * 
 * @author Lorelei
 *
 */
public abstract class AbstractSource extends AbstractSingleOutputPipeComponent implements Source {
	...
	public AbstractSource(DataGenerator<ElementSourcedEvent> elementGenerator, int arrivals) {
	 ...
	 * 
	 * @param tick The {@link EngineTick} in which the arrival will happen.
	 */
	@Override
	protected void generateEvents(EngineTick tick) {
		if (sourced < arrivals) {
			...
			final Component to = getTransferOutputPipe().getUnion().getDownStreamPipe().getOwner();

			final ElementTransferData data = new ElementTransferData(this, to, event.getElement(), event.getTime());
