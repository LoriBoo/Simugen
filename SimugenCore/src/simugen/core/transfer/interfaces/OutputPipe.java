 ...
 *
 * @param <T>
 *            Subclass of {@link PipeData} that this {@link OutputPipe} sends.
 * @param <V>
 *            Subclass of {@link InputPipe} that this {@link OutputPipe} can be
 *            unioned to.
 */
public interface OutputPipe<T extends PipeData<?>, V extends InputPipe<T>>
{
	...
	/**
	 * @param pipeData
	 *            The {@link PipeData} to be sent to the downstream
	 *            {@link Component}.
	 ...
	 * 
	 * @param inputPipe
	 *            The {@link InputPipe} to be unioned to this
	 *            {@link OutputPipe}.
	 */
