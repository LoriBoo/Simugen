 ...
 * T must extend {@link SingleTransferInputPipe}, which allows the owning
 * object to receive elements.
 * 
 * @author Lorelei
 *
 * @param <T> subclass of {@link SingleTransferInputPipe}
 */
public class DefaultElementTransferDataContext<T extends SingleTransferInputPipe>
