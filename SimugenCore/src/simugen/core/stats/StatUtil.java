...
public class StatUtil
{
	 ...
	 * <br>
	 * I wrote this when I had a better understanding of probability and
	 * statistics and I'm not quite sure what everything is now, and I can't
	 * easily find information on this test on wikipedia.
	 * 
	 * @param CI
	 *            Confidence Interval
	 * @param s
	 ...
	 * @param maxRuns
	 *            The upper bound of the number of reps test so that it doesn't
	 *            go on to infinity.
	 * @return The number of reps required to get the desired Confidence
	 *         Interval
	 ...
	 * @throws MathIllegalStateException
	 */
	private static double getT_TestValue(double CI, int df)
			throws MathIllegalStateException
	{
	 ...
	 * 
	 * @param t
	 *            T value from the T test of the desired CI and the degrees of
	 *            freedom.
	 * @param s
	 *            Standard deviation of the sample.
	 * @param N
