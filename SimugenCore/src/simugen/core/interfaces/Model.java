...
public interface Model {
	 ...
	 * 
	 * @param run   The current run, zero-indexed.
	 * @param seed  The seed for the current run. Passed to the {@link Model} for
	 ...
	 * @param epoch The Epoch of the {@link Engine}, in milliseconds from the Java
	...
	/**
	 * Called by {@link #startUp(int, long, long)}, for subclasses to instantiate
	 * resources, and build the model.<br>
	 * <br>
	...
	/**
	 * @param component The {@link Component} to be added to the model. The
	 ...
	 *         {@link Event}s generally are generated by the {@link Component}s of
	 *         the {@link Model}.
	 */
	 ...
	 *         {@link #addListener(EventListener)}. Called by the {@link Engine}.
	 */
	public List<EventListener<?>> getListeners();

	/**
	 * @param listener The {@link EventListener} to be added to the {@link Model}.
	 */
	public void addListener(EventListener<?> listener);

	/**
	 * @param location The output location used by {@link EventListener}s to output
	 *                 data, e.g. like outputting to a common Database.
	 */
	public void setOutputLocation(String location);

	/**
	 * @return The output location used by {@link EventListener}s to output data,
	 *         e.g. like outputting to a common Database.
	 */
